        ...
        Thread send_sever = new Thread(new Runnable(){
            public void run(){                                   
                    ...
                    if(!str.equals(""))
                    {
                        ...
                        msg2=new JLabel("");
                        msg2.setText("<html><div style='height:20px'><p style='text-align:left;width:100%;font-size:10px' >"+"Me:-"+str+"</p>"+"<p style='text-align:right;width:100%;font:size:2px'>"+msg_tm+"</p></div></html>");
        ...
        Thread receive_sever = new Thread(new Runnable(){
            public void run(){ 
                while(true){
                        ...
                        System.out.println(msg_tm);
                         msg=new JLabel("");
                         msg.setText("<html><div style='height:20px'><p style='text-align:right;width:100%;font-size:10px' >"+"Client:-"+str1+"</p>"+"<p style='text-align:right;width:100%;font:size:2px'>"+msg_tm+"</label></div></html>");
