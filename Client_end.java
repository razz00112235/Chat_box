...
static void home()
    ...
    {      Thread sendmsg = new Thread(new Runnable(){
                        public void run(){   
                            ...
                            {
                                msg2=new JLabel("");
                                msg2.setText("<html><div style='height:20px'><p style='text-align:left;width:100%;font-size:10px' >"+"Me:-"+str1+"</p>"+"<p style='text-align:right;width:100%;font:size:2px'>"+msg_tm+"</p></div></html>");
                    ...
                    Thread recievemsg = new Thread(new Runnable(){
                        public void run(){ 
                            ...
                            while(true)
                            {
                                ...
                                {
                                    msg=new JLabel("");
                                    msg.setText("<html><div style='height:20px'><p style='text-align:right;width:100%;font-size:10px' >"+"Server:-"+str+"</p>"+"<p style='text-align:right;width:100%;font:size:2px'>"+msg_tm+"</label></div></html>");
